...
export const Skill = ({ directionLeft, skillName, proficiency }: Props) => {
  return (
    <div className="group relative cursor-pointer flex">
      ...
      />
      <div className="absolute opacity-0 group-hover:opacity-100 transition duration-300 group-hover:bg-gray-50 h-24 md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0">
